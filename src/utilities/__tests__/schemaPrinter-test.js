...
directive @deprecated(
  ...
  # Explains why this element was deprecated, usually also including a suggestion for how
  # to access supported similar data. Formatted in
...
#
# In some cases, you need to provide options to alter GraphQL's execution behavior in ways
# field arguments will not suffice, such as conditionally including or skipping a field.
...
# One possible value for a given Enum. Enum values are unique values, not a placeholder
# for a string or numeric value. However an Enum value is returned in a JSON response as a string.
type __EnumValue {
  name: String!
  description: String
...
# Abstract types, Union and Interface, provide the Object types possible at runtime. List
# and NonNull types compose other types.
type __Type {
  kind: __TypeKind!
  name: String
  description: String
