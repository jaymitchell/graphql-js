 ...
 */
function loc(lexer: Lexer<*>, startToken: Token): ?Location {
  if (!lexer.options.noLocation) {
    const endToken = lexer.lastToken;
    return Object.defineProperties({}, {
      start: { enumerable: true, value: startToken.start },
      end: { enumerable: true, value: endToken.end },
      startToken: { value: startToken },
      endToken: { value: endToken },
      source: { value: lexer.source }
    });
  }
}
